...
$c->add(
	[
		...
		'sphrofAppl'=>'Для тіла',
		'properties'=>'{"SPF": "6", "Вікова категорія": "18+", "Консистенція": "Масло", "Країна-виробник: ": "Україна", "Об’єм упаковки": "160"  }'
	]
);
$c->add(
	[
		...
		'applTime'=>'Універсальні',
		'sphrofAppl'=>'Для тіла',
		'properties'=>'{"SPF": "50", "Вікова категорія": "3+", "Консистенція": "Спрей", "Країна-виробник: ": "Іспанія", "Об’єм упаковки": "200"  }'
	]
);
$c->display();
$c->update(
